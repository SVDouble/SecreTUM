...
# NOTE: The code was adjusted to include cs_arrays, which is not present in the original code.
...
def convert_to_measurement(m, **kwargs):
    ...
    for n, array in enumerate(arrays):
        try:
            ...
            array_type = (
                ArrayType.Unspecified
            )  # arraytype not implemented in ArrayType enum
